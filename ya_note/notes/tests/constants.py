...
class UrlsConstants():
    ...
    REDIRECT_FROM_NOTE_ADD_TO_LOGIN_URL = (
        f'{LOGIN_URL}?next={NOTE_ADD_URL}'
    )
    REDIRECT_FROM_NOTES_LIST_TO_LOGIN_URL = (
        f'{LOGIN_URL}?next={NOTES_LIST_URL}'
    )
    REDIRECT_FROM_SUCCESS_TO_LOGIN_URL = (
        f'{LOGIN_URL}?next={SUCCESS_URL}'
    )
    REDIRECT_FROM_NOTE_DETAIL_TO_LOGIN_URL = (
        f'{LOGIN_URL}?next={NOTE_DETAIL_URL}'
    )
    REDIRECT_FROM_NOTE_EDIT_TO_LOGIN_URL = (
        f'{LOGIN_URL}?next={NOTE_EDIT_URL}'
    )
    REDIRECT_FROM_NOTE_DELETE_TO_LOGIN_URL = (
